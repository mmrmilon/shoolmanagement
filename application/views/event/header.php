...
<head>
	...
	<script src="<?php echo $headerData['assets']?>angular/js/angular-strap.js"></script>		
	<script src="<?php echo $headerData['assets']?>angular/js/angular-strap.tpl.js"></script>
