			...
			submitHandler: function(ev)
			{
				...
				*/
				...
				setTimeout(function()
				{
					...
					//alert($("input#email").val()+', '+$("input#password").val()+', '+$("input#remember_me").val());
					$.ajax({
						...
						data: {
							...
							remember_me: $("input#remember_me").val(),
						},
						error: function()
						{
							...
							setTimeout(function()
							{
								...
								if(login_status == 'success')
								{
									...
									setTimeout(function()
									{
										...
										//alert(response.redirect_url+' && '+response.redirect_url.length);
